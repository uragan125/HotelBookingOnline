...
<meta charset="UTF-8">
    ...
    <title>Hotel Booking Online - КОНТАКТЫ</title>
...
<!--header-->
 ...
 <div class="my-5 px-4">
    ...
    <p class="text-center mt-4">Мы готовы помочь вам с любыми вопросами или бронированием. Свяжитесь с Hotel Booking Online для получения информации о доступности номеров, специальных предложениях или организации мероприятий. Наша дружелюбная команда всегда готова сделать ваше пребывание незабываемым. Вы можете связаться с нами по телефону, электронной почте или заполнить форму ниже, и мы оперативно ответим. Ждем вас с нетерпением!</p>
</div>  
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-md-6 mb- px-4">
            ...
            <i class="bi bi-geo-alt"></i> Страна, Омск, Weligama.</a>  
